...
const amizadeController = require('./amizade');
const categoriaController = require('./categoria');
const categoriaTraducaoController = require('./categoriaTraducao');
const comentarioController = require('./comentario');
const compartilhamentoController = require('./compartilhamento');
...
const mensagemDiretaController = require('./mensagemDireta');
